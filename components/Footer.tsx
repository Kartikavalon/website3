    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="container mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-serif font-semibold text-gray-900 mb-4">Products</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-serif font-semibold text-gray-900 mb-4">Company</h3>
            <ul className="space-y-2 text-sm font-sans text-gray-700">
              <li>
          ...
          {/* Contact & Social */}
          <div>
            <h3 className="font-serif font-semibold text-gray-900 mb-4">Contact</h3>
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              <Link href="/privacy" className="text-gray-600 hover:text-primary-600 text-sm font-sans transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-600 hover:text-primary-600 text-sm font-sans transition-colors">
                Terms of Service
              </Link>
              <Link href="/contact" className="text-gray-600 hover:text-primary-600 text-sm font-sans transition-colors">
                Contact Us
              </Link>
            </div>
          </div>

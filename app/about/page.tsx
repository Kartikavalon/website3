    ...
    <main className="w-full bg-white text-gray-900">
      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-industrial">
        <div className="container mx-auto max-w-5xl text-center">
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
            ...
            <span className="text-teal-500 drop-shadow-[0_0_12px_rgba(20,184,166,0.25)]">Industries</span>
          </h1>
      ...
      <section className="py-20 px-4 bg-gradient-industrial">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <a
            href="/contact"
            className="inline-block px-8 py-4 bg-primary-600 text-contrast font-sans font-semibold rounded hover:bg-primary-500 transition-all duration-300 hover:shadow-glow-teal"
          >
            Get in Touch
          </a>
        </div>
